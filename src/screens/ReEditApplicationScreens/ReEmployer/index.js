...
export default function ReEmployer(props) {
	const { contaxtprofileData } = useCart();
	...
	const [EmpEmailAddress, onEmpEmailAddress] = React.useState(contaxtprofileData?.empEmailAddress ? contaxtprofileData.empEmailAddress :'');
	const [EmpName, onEmpName] = React.useState(contaxtprofileData?.empName ? contaxtprofileData.empName :'');
	const [EmpOccupation, onEmpOccupation] = React.useState(contaxtprofileData?.empOccupation ? contaxtprofileData.empOccupation :'');
	const [EmpOffieNumber, onEmpOffieNumber] = React.useState(contaxtprofileData?.empOffieNumber ? contaxtprofileData.empOffieNumber :'');
	const [EmpNextOfKinFullName, onEmpNextOfKinFullName] = React.useState(contaxtprofileData?.empNextOfKinFullName ? contaxtprofileData.empNextOfKinFullName :'');
	const [EmpNextOfKinSurName, onEmpNextOfKinSurName] = React.useState(contaxtprofileData?.empNextOfKinSurName ? contaxtprofileData.empNextOfKinSurName :'');
	const [EmpRelationship, onEmpRelationship] = React.useState(contaxtprofileData?.empRelationship ? contaxtprofileData.empRelationship :'');
	const [EmpNextOfKinMobileNumber, onEmpNextOfKinMobileNumber] = React.useState(contaxtprofileData?.empNextOfKinMobileNumber ? contaxtprofileData.empNextOfKinMobileNumber :'');
	const [EmpPoBox, onEmpPoBox] = React.useState(contaxtprofileData?.empPoBox ? contaxtprofileData.empPoBox :'');
	const [EmpCode, onEmpCode] = React.useState(contaxtprofileData?.empCode ? contaxtprofileData.empCode :'');
	...
	const SignupCommand = () => {
		...
		props.navigation.navigate('ReUploadSelfie', {
					...
					<View style={{ marginTop: 15 }}>
						<View style={styles._input_view}>
							...
							<TextInput
								...
								style={styles._input}
								// editable={!contaxtprofileData?.empEmailAddress} // Disable if mobileNumber exists
							/>
						</View>
						<View style={styles._input_view}>
